                    ...
                    if (normal_number_array[i] == b_a_nums[ii].num1){
                        for (int y = 0; y < i; y++){
                            if (normal_number_array[y] == b_a_nums[ii].num2){
                                ...
                                int tmp = normal_number_array[i];
                                normal_number_array[i] = normal_number_array[y];
                                normal_number_array[y] = tmp;
                                swapped = true;
